...
export class InitTables1705108096504 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "black_list" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" character varying NOT NULL, CONSTRAINT "PK_6969ca1c62bdf4fef47a85b8195" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "login_information" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userAgent" character varying NOT NULL, "lastVisit" TIMESTAMP NOT NULL, "isLogout" boolean NOT NULL, "userId" uuid, CONSTRAINT "PK_ad5d81480b774478c8300b98b09" PRIMARY KEY ("id"))`);
